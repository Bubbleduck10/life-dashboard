...
const CHAT_INTENTS = [
  ...
  },
  {
    ...
    answer: "The <strong>Currency</strong> selector in the Log-a-trading-day form lets you track <strong>SOL, USDC, ETH, BTC, BNB, or HYPE</strong>. You can log <strong>several currencies on the same day</strong> — just log the date again with a different coin and both entries stack (re-logging the same date + coin overwrites it). USDC counts as $1 flat; ETH and BTC use live and historical day-of prices like SOL. The day's card, calendar, and totals combine them into one USD figure."
  },
  {
